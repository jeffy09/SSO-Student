        ...
        <div class="row justify-content-center w-100">
            <div class="col-md-8 col-lg-6 col-xxl-3">
                <div class="login-logo-container text-center mb-4">
                    <h2 class="text-primary fw-bold">ระบบบริหารจัดการข้อมูลระบบสำหรับนักศึกษา</h2>
                </div>
                <div class="card mb-0 login-card">
                    <div class="card-body">
                        ...
                        <form action="?page=home" method="post">
                            ...
                            <div class="mb-4"> <label for="id_card" class="form-label">รหัสผ่าน</label>
                                <input type="password" class="form-control fs-6" id="id_card" name="id_card" required placeholder="กรอกรหัสผ่าน">
                            </div>
